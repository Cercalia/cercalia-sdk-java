...
public final class TimezoneResult {
    ...
    private TimezoneResult(Builder builder) {
    ...
    /**
     * Returns the input coordinate used for the query.
     *
    ...
    public boolean equals(Object o) {
        ...
        TimezoneResult that = (TimezoneResult) o;
    ...
    public static final class Builder {
        ...
        public TimezoneResult build() {
            return new TimezoneResult(this);
        }
    }
}
